...
import { TravisNgTestModule } from '../../../test.module';
import { CustomMetricsMonitoringModalComponent } from 'app/admin/metrics/metrics-modal.component';
import { CustomMetricsService } from 'app/admin/metrics/metrics.service';

describe('Component Tests', () => {
    describe('CustomMetricsMonitoringModalComponent', () => {
        let comp: CustomMetricsMonitoringModalComponent;
        let fixture: ComponentFixture<CustomMetricsMonitoringModalComponent>;
        let service: CustomMetricsService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [TravisNgTestModule],
                declarations: [CustomMetricsMonitoringModalComponent]
            })
                .overrideTemplate(CustomMetricsMonitoringModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(CustomMetricsMonitoringModalComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(CustomMetricsService);
        });
