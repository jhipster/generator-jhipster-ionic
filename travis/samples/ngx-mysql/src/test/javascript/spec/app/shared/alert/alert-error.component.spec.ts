...
import { CustomAlertErrorComponent } from 'app/shared/alert/alert-error.component';
import { MockAlertService } from '../../../helpers/mock-alert.service';

describe('Component Tests', () => {
    describe('Alert Error Component', () => {
        let comp: CustomAlertErrorComponent;
        let fixture: ComponentFixture<CustomAlertErrorComponent>;
        let eventManager: JhiEventManager;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [TravisNgTestModule, TranslateModule.forRoot()],
                ...
                .overrideTemplate(CustomAlertErrorComponent, '')
                .compileComponents();
        }));
        ...
        describe('Error Handling', () => {
            it('Should display an alert on status 0', () => {
                // GIVEN
                eventManager.broadcast({ name: 'travisNgApp.httpError', content: { status: 0 } });
                // THEN
            ...
            it('Should display an alert on status 404', () => {
                // GIVEN
                eventManager.broadcast({ name: 'travisNgApp.httpError', content: { status: 404 } });
                // THEN
                expect(comp.alerts.length).toBe(1);
            ...
            it('Should display an alert on generic error', () => {
                // GIVEN
                eventManager.broadcast({ name: 'travisNgApp.httpError', content: { error: { message: 'Error Message' } } });
                eventManager.broadcast({ name: 'travisNgApp.httpError', content: { error: 'Second Error Message' } });
                // THEN
            ...
            it('Should display an alert on status 400 for generic error', () => {
                ...
                eventManager.broadcast({ name: 'travisNgApp.httpError', content: response });
                // THEN
                expect(comp.alerts.length).toBe(1);
