...
import { CustomHealthCheckComponent } from 'app/admin/health/health.component';
import { CustomHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('CustomHealthCheckComponent', () => {
        let comp: CustomHealthCheckComponent;
        let fixture: ComponentFixture<CustomHealthCheckComponent>;
        let service: CustomHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [TravisNgTestModule],
                declarations: [CustomHealthCheckComponent]
            })
                .overrideTemplate(CustomHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(CustomHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(CustomHealthService);
        });
