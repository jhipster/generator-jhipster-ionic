...
module.exports = class extends BaseGenerator {
    constructor(args, opts) {
        ...
        useBlueprint = this.composeBlueprint(blueprint, 'entity'); // use global variable since getters don't have access to instance property
    }
    ...
    get initializing() {
        ...
        return {
            getConfig() {
                ...
                context.jhiTablePrefix = this.getTableName(this.jhiPrefix);
                ...
                context.protractorTests = context.testFrameworks.indexOf('protractor') !== -1;
                context.gatlingTests = context.testFrameworks.indexOf('gatling') !== -1;
                context.cucumberTests = context.testFrameworks.indexOf('cucumber') !== -1;
                ...
                if (shelljs.test('-f', context.filename)) {
                    ...
                    context.fromPath = this.filename;
                }
            },
    ...
    get configuring() {
        ...
        return {
            ...
            writeEntityJson() {
                ...
                this.copyFilteringFlag(this, this.data, context);
                if (['sql', 'mongodb', 'couchbase'].includes(context.databaseType)) {
                ...
                if (context.applicationType === 'gateway' && context.useBackendJson) {
